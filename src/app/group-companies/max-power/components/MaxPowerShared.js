  ...
  return (
    ...
    >
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        {/* Brand Logo */}
        <Link href="/group-companies/max-power" className="flex items-center gap-2.5 select-none group">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[9px] sm:text-[9.5px] font-bold tracking-widest uppercase mt-0.5" style={{ color: theme.amberDark }}>
