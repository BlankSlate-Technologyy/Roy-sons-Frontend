...
import {
  SWISS_FARM_PRODUCTS,
  getSwissFarmProductBySlug,
} from "../../products-data";

export default function SwissFarmProductDetailPage({ params }) {
  const unwrappedParams = use(params);
  const slug = unwrappedParams?.slug;
  const product = getSwissFarmProductBySlug(slug);
  ...
  const otherProducts = SWISS_FARM_PRODUCTS.filter(
  ...
  return (
    <main className="min-h-screen bg-white text-[#1C522A] font-sans antialiased overflow-x-hidden">
        ...
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              >
                <Package size={14} style={{ color: theme.accentGold }} />
              ...
              <div className="flex flex-wrap items-center gap-4 pt-3">
                ...
                >
                  <span>Request Contract &amp; Lab Assay</span>
                  <ArrowRight size={15} />
                </Link>
                <a
      ...
      {/* ─── 1-Click Sticky Product Switcher Tabs ───────────────────────── */}
      <div
      ...
      >
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 overflow-x-auto py-3 no-scrollbar">
            {SWISS_FARM_PRODUCTS.map((p) => {
              const isCurrent = p.slug === product.slug;
              return (
                <Link
                  key={p.slug}
                  href={`/group-companies/swiss-farm/products/${p.slug}`}
      ...
      {/* ─── 4 Core Strategic Production Pillars ─────────────────────────── */}
      <section className="py-16 lg:py-24 bg-white border-b" style={{ borderColor: theme.border }}>
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <SectionLabel center>Quality Standard</SectionLabel>
            <SectionHeading center className="mb-3">
              Strategic Production Pillars for {product.name}
            </SectionHeading>
            <p className="text-sm sm:text-base font-medium" style={{ color: theme.textMuted }}>
              Strict laboratory assays, cold-chain integrity, and uncompromised food safety protocols.
            </p>
          </div>
      ...
      {/* ─── Scope of Supply & Chemical / Physical Specs Profile ─────────── */}
      <section
            ...
            <div className="lg:col-span-6 space-y-6">
              <div>
                ...
                <SectionHeading className="mb-3">
                  Key Supply Deliverables
                </SectionHeading>
                <p className="text-xs sm:text-sm font-medium" style={{ color: theme.textMuted }}>
                  Every consignment includes official laboratory certificates, batch serial tracking, and temperature logs.
                </p>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-medium">Standardized laboratory benchmarks</p>
                  </div>
                </div>
      ...
      {/* ─── 4-Stage Extraction & QA Pathway ────────────────────────────── */}
      <section className="py-16 lg:py-24 bg-white border-b" style={{ borderColor: theme.border }}>
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <SectionLabel center>Quality Lifecycle</SectionLabel>
            <SectionHeading center className="mb-3">
              Extraction &amp; Quality Assurance Pathway
            </SectionHeading>
            <p className="text-sm sm:text-base font-medium" style={{ color: theme.textMuted }}>
              From initial raw processing to precision laboratory assaying and refrigerated logistics dispatch.
            </p>
          </div>
      ...
      <section className="py-16 lg:py-20 bg-[#F4F8F4] border-b" style={{ borderColor: theme.border }}>
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="text-center">
            <SectionLabel center>Product Inquiries</SectionLabel>
            <SectionHeading center className="mb-3">
              Frequently Asked Questions
            </SectionHeading>
            <p className="text-xs sm:text-sm font-medium" style={{ color: theme.textMuted }}>
              Key clarifications regarding contract terms, packaging, and laboratory testing protocols.
            </p>
          </div>
      ...
      {/* ─── Other Dairy Products Navigation Grid ───────────────────────── */}
      <section className="py-16 lg:py-20 bg-white border-b" style={{ borderColor: theme.border }}>
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
            <div>
              <SectionLabel>Full Product Line</SectionLabel>
              <SectionHeading>Other Dairy Products &amp; Genetics</SectionHeading>
            </div>
            <Link
              href="/group-companies/swiss-farm/products"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {otherProducts.slice(0, 3).map((other) => (
              <Link
                key={other.slug}
                href={`/group-companies/swiss-farm/products/${other.slug}`}
        ...
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="max-w-2xl space-y-3">
              ...
              >
                COMMERCIAL CONTRACT SUPPLY DESK
              </span>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black uppercase leading-tight" style={{ color: theme.primary }}>
                Request A Supply Agreement For {product.name}
              </h2>
              <p className="text-xs sm:text-sm font-medium leading-relaxed" style={{ color: theme.textMuted }}>
                We execute tailored B2B supply agreements with commercial dairy processors, cheese manufacturers, hotels, and corporate livestock farms.
              </p>
            </div>
