  ...
  return (
    ...
    >
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        {/* Brand Logo */}
        <Link href="/group-companies/digitalzone" className="flex items-center gap-2.5 select-none group">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[9px] sm:text-[9.5px] font-bold tracking-widest uppercase mt-0.5" style={{ color: theme.cyan }}>
          ...
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                key={link.label}
                href={link.href}
                className="text-[11.5px] xl:text-xs font-bold tracking-wide uppercase transition-all duration-200 relative py-1 px-1 hover:text-[#0A3A6B] cursor-pointer"
                style={{
