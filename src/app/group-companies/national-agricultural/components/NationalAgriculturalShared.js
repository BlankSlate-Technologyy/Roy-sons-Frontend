      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <Link href="/group-companies/national-agricultural" className="flex items-center gap-3 select-none group">
          ...
          <div className="flex flex-col">
            <span className="text-base sm:text-lg font-black tracking-wide leading-tight uppercase" style={{ color: theme.primary }}>
              National Agricultural
            </span>
            <span className="text-[9.5px] sm:text-[10.5px] font-bold tracking-[0.2em] uppercase" style={{ color: theme.accent }}>
              Corporation (Pvt) Ltd
            </span>
          </div>
        </Link>
          ...
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                key={link.label}
                href={link.href}
                className="text-[13px] font-bold tracking-wide uppercase transition-all duration-200 relative py-1 hover:text-[#E8A800] cursor-pointer"
                style={{
        ...
        >
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                ...
                style={{
                  color: active ? theme.accent : theme.primary,
                  borderColor: "rgba(212, 232, 208, 0.6)",
                }}
              >
          ...
          <div className="pt-2">
            <Link
              ...
              style={{ backgroundColor: theme.primary }}
            >
              <span>Get Farm Development Quote</span>
              <ArrowRight size={14} />
            </Link>
          </div>
        </div>
