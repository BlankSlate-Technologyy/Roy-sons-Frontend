...
export async function POST(req) {
  try {
    ...
    const contactDoc = await CompanyContact.create({
      companySlug: "national-agricalture",
      companyName: "National Agriculture Corporation",
      fullName: applicantName,
      email,
      phone: phone || "",
      subject: subject || "Agricultural Inquiry",
      message,
    ...
    console.error("National Agriculture Contact API Error:", error);
