  ...
  return (
    ...
    >
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        {/* Brand Logo */}
        <Link href="/group-companies/swiss-homes" className="flex items-center gap-3 select-none group">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[9.5px] sm:text-[10.5px] font-bold tracking-[0.2em] uppercase" style={{ color: theme.red }}>
              Real Estate &amp; Housing
            </span>
          </div>
        </Link>
          ...
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                key={link.label}
                href={link.href}
                className="text-[13px] font-bold tracking-wide uppercase transition-all duration-200 relative py-1 hover:text-[#B01B2E] cursor-pointer"
                style={{
        ...
        >
          ...
          <div className="pt-2">
            <Link
              ...
              style={{ backgroundColor: theme.red }}
            >
              <span>Explore Available Plots &amp; Villas</span>
              <ArrowRight size={14} />
            </Link>
          </div>
        </div>
