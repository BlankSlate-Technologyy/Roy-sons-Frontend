      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <Link href="/group-companies/swiss-homes" className="flex items-center gap-3 select-none group">
          ...
          <div className="flex flex-col">
            <span className="text-sm sm:text-base lg:text-lg font-black tracking-tight leading-none uppercase" style={{ color: theme.charcoal }}>
              Swiss Homes
            </span>
            <span className="text-[9.5px] sm:text-[10px] font-bold tracking-widest uppercase mt-1" style={{ color: theme.red }}>
              Real Estate &amp; Housing
            </span>
          </div>
        </Link>
