...
import {
  WALTON_SERVICES,
  getWaltonServiceBySlug,
} from "../../services-data";

export default function WaltonServiceDetailPage({ params }) {
  const unwrappedParams = use(params);
  const slug = unwrappedParams?.slug;
  const service = getWaltonServiceBySlug(slug);
  ...
  const otherServices = WALTON_SERVICES.filter(
  ...
  return (
    <main className="min-h-screen bg-white text-[#3A4E63] font-sans antialiased overflow-x-hidden">
              ...
              >
                <div className="relative w-full h-[320px] sm:h-[400px] overflow-hidden bg-slate-100">
                  <Image
                    ...
                    alt={`${service.title} - Walton Consultants & Contracting`}
                    fill
      ...
      >
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 overflow-x-auto py-3 no-scrollbar">
            {WALTON_SERVICES.map((s) => {
              const isCurrent = s.slug === service.slug;
              return (
                <Link
                  key={s.slug}
                  href={`/group-companies/walton-consultants-contracting/services/${s.slug}`}
      ...
      <section className="py-16 lg:py-24 bg-white border-b" style={{ borderColor: theme.border }}>
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <SectionLabel center>Engineering Excellence</SectionLabel>
        ...
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-6 space-y-6">
              <div>
                <SectionLabel>Division Scope</SectionLabel>
                <SectionHeading className="mb-3">
                  Technical Deliverables Included
                </SectionHeading>
                <p className="text-xs sm:text-sm font-medium" style={{ color: theme.textMuted }}>
                  Every project deployment includes certified on-site quality testing, Primavera P6 telemetry, and safety oversight.
                </p>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-medium">Standardized construction benchmarks</p>
                  </div>
                </div>
      ...
      <section className="py-16 lg:py-24 bg-white border-b" style={{ borderColor: theme.border }}>
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <SectionHeading center className="mb-3">
              How We Execute &amp; Supervise {service.title}
            </SectionHeading>
            <p className="text-sm sm:text-base font-medium" style={{ color: theme.textMuted }}>
              From initial geotechnical assay and structural modeling to heavy construction, QA testing, and commissioning.
            </p>
          </div>
      ...
      <section className="py-16 lg:py-20 bg-[#F4F7FA] border-b" style={{ borderColor: theme.border }}>
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="text-center">
            <SectionLabel center>Engineering Inquiries</SectionLabel>
            <SectionHeading center className="mb-3">
              Frequently Asked Questions
            </SectionHeading>
            <p className="text-xs sm:text-sm font-medium" style={{ color: theme.textMuted }}>
              Key clarifications regarding structural standards, tender bidding, and project timelines.
            </p>
          </div>
      ...
      {/* ─── Other Engineering Divisions Navigation Grid ────────────────── */}
        ...
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
            <div>
              ...
              <SectionHeading>Other Engineering Divisions</SectionHeading>
            </div>
            <Link
              href="/group-companies/walton-consultants-contracting/services"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {otherServices.slice(0, 3).map((other) => (
              <Link
                key={other.slug}
                href={`/group-companies/walton-consultants-contracting/services/${other.slug}`}
        ...
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="max-w-2xl space-y-3">
              ...
              >
                CIVIL GENERAL CONTRACTING DESK
              </span>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black uppercase leading-tight" style={{ color: theme.navyDark }}>
                Consult With Our Chief Engineer For {service.title}
              </h2>
              <p className="text-xs sm:text-sm font-medium leading-relaxed" style={{ color: theme.textMuted }}>
                Speak directly with our senior structural consultants and project directors to review architectural drawings, BOQs, and tender bids.
              </p>
            </div>
