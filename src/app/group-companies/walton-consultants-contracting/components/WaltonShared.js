          ...
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                key={link.label}
                href={link.href}
                className="text-[13px] font-bold tracking-wide uppercase transition-all duration-200 relative py-1 hover:text-[#0E2A47] cursor-pointer"
                style={{
          ...
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                ...
                style={{
                  color: active ? theme.navy : theme.charcoal,
                  borderColor: "rgba(216, 226, 236, 0.7)",
                }}
              >
