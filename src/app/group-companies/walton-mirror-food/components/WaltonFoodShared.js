      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <Link href="/group-companies/walton-mirror-food" className="flex items-center gap-3 select-none group">
          ...
          <div className="flex flex-col">
            <span className="text-base sm:text-lg font-black tracking-wide leading-tight uppercase" style={{ color: theme.greenDark }}>
              Walton &amp; Morris Foods
            </span>
            <span className="text-[9.5px] sm:text-[10.5px] font-bold tracking-[0.2em] uppercase" style={{ color: theme.ochre }}>
          ...
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                key={link.label}
                href={link.href}
                className="text-[13px] font-bold tracking-wide uppercase transition-all duration-200 relative py-1 hover:text-[#1E6B43] cursor-pointer"
                style={{
              ...
              >
                ...
                <span
                  ...
                  style={{ backgroundColor: theme.ochre }}
                />
              </Link>
            );
          })}
          ...
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                ...
                style={{
                  color: active ? theme.green : theme.textMuted,
                  borderColor: "rgba(211, 228, 219, 0.7)",
                }}
              >
