  ...
  return (
    ...
    >
      <div className="w-full max-w-[1400px] mx-auto px-3 sm:px-5 lg:px-6 xl:px-8 flex items-center justify-between">
        {/* Brand Logo */}
        <Link href="/group-companies/national-food" className="flex items-center gap-2.5 select-none group py-0.5">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[9px] sm:text-[9.5px] font-bold tracking-widest uppercase mt-0.5" style={{ color: theme.forestGreen }}>
              Institutional Catering &amp; Food Supply
            </span>
          </div>
        </Link>

        {/* Desktop Navigation Links - No CTA button, clean and balanced */}
