  ...
  return (
    ...
    >
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        {/* Brand Logo */}
        <Link href="/group-companies/pak-janitorial" className="flex items-center gap-3 select-none group">
          ...
          <div className="flex flex-col">
            <span className="text-base sm:text-lg font-black tracking-wide leading-tight uppercase" style={{ color: theme.royalBlueDark }}>
              Pakistan Medical Supplies
            </span>
            <span className="text-[9.5px] sm:text-[10.5px] font-bold tracking-[0.2em] uppercase" style={{ color: theme.skyBlue }}>
          ...
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                key={link.label}
                href={link.href}
                className="text-[13px] font-bold tracking-wide uppercase transition-all duration-200 relative py-1 hover:text-[#1A4FA0] cursor-pointer"
                style={{
              ...
              >
                ...
                <span
                  ...
                  style={{ backgroundColor: theme.skyBlue }}
                />
              </Link>
            );
          })}
        ...
        >
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                ...
                style={{
                  color: active ? theme.royalBlue : theme.charcoal,
                  borderColor: "rgba(210, 228, 245, 0.7)",
                }}
              >
          ...
          <div className="pt-2">
            <Link
              ...
              style={{ backgroundColor: theme.royalBlue }}
            >
              <span>Request Turnkey Hospital Proposal</span>
              <ArrowRight size={14} />
            </Link>
          </div>
        </div>
