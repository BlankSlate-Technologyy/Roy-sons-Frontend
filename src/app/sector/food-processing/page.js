          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            <div className="lg:col-span-7 flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-[2px] bg-[#0a7a8c]/25 border border-cyan-400/80 text-cyan-300 text-xs sm:text-[13px] font-bold uppercase tracking-[0.2em] mb-5 self-start shadow-[0_0_15px_rgba(34,211,238,0.25)]">
                <Utensils size={15} className="text-cyan-400" />
            ...
            <div className="lg:col-span-5">
              <ServiceHeroSlider slides={HERO_SLIDES} defaultTag="FOOD PROCESSING" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/3">
              <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#0a7a8c] mb-2 block">TARGET MARKETS</span>
            ...
            <div className="md:w-2/3 w-full">
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                {FOCUS_AREAS.map((area, idx) => (
                  <div key={idx} className="bg-white border border-neutral-200 p-4 rounded-[2px] flex items-center gap-3 group hover:border-[#009688] hover:shadow-md transition-all duration-300">
                    <span className="w-2.5 h-2.5 rounded-full bg-[#0a7a8c] group-hover:scale-125 group-hover:bg-[#009688] transition-all" />
                    <span className="text-xs sm:text-sm font-bold text-neutral-800 uppercase tracking-wide group-hover:text-[#009688] transition-colors">{area}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section id="capabilities" className="py-14 sm:py-18 bg-white border-b border-neutral-200">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#0a7a8c] mb-2 block">PROCESSING EXPERTISE</span>
