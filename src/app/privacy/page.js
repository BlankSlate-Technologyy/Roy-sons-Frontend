        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <aside className="hidden lg:block lg:col-span-4 sticky top-28 bg-[#1a2127] p-6 rounded-sm border border-[#dfb753]/25">
            ...
            <div className="mt-6 pt-4 border-t border-[#dfb753]/20">
              <p className="text-[11px] text-neutral-400 mb-2">Have a privacy inquiry?</p>
              <Link
                href="/contact"
          ...
          <div className="lg:col-span-8 text-neutral-200 text-[15px] sm:text-[15.5px] leading-[1.8]">
            ...
            <section id="collection" className="mb-12 scroll-mt-28">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 my-4">
                {[
                  ...
                  <li key={idx} className="flex items-center gap-2.5 p-3 bg-[#1a2127] border border-[#dfb753]/20 rounded-sm text-[13.5px] font-medium text-neutral-200">
                    <CheckCircle2 size={15} className="text-[#dfb753] flex-shrink-0" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
              <p className="mt-4 mb-3 text-neutral-300">
              ...
              <div className="mt-6 p-5 bg-[#1a2127] border border-[#dfb753]/20 rounded-sm">
                <h3 className="text-sm font-bold uppercase tracking-wider text-[#dfb753] mb-2 flex items-center gap-2">
                  <Server size={14} className="text-[#dfb753]" />
                  <span>Automatically Collected Technical Information</span>
                </h3>
                <p className="text-[13.5px] text-neutral-300 leading-relaxed mb-3">
                ...
                <p className="text-[13px] text-[#dfb753]/80 italic">
            ...
            <section id="usage" className="mb-12 scroll-mt-28">
              ...
              <ul className="space-y-2.5 pl-2 mb-6 text-neutral-300">
                {[
            ...
            <section id="sharing" className="mb-12 scroll-mt-28">
              ...
              <div className="p-4 bg-[#1a2127] border-l-4 border-[#dfb753] border-y border-r border-[#dfb753]/20 font-medium text-neutral-200 mb-4">
              ...
              <ul className="space-y-1.5 pl-4 mb-4 list-disc text-[14px] text-neutral-300">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 my-4">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-2.5 p-3 bg-[#1a2127] border border-[#dfb753]/20 rounded-sm text-[13.5px] font-medium text-neutral-200">
                    <UserCheck size={15} className="text-[#dfb753] flex-shrink-0" />
                    <span>{item}</span>
                  </div>
                ))}
              </div>
