          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            <div className="lg:col-span-7 flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-[2px] bg-[#C6A15A]/15 border border-[#C6A15A]/40 text-[#C6A15A] text-xs font-bold uppercase tracking-[0.2em] mb-5 self-start">
                <Cpu size={15} className="text-[#C6A15A]" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {AI_SOLUTIONS.map((sol, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-[#161c20] border border-neutral-800 p-5 sm:p-6 rounded-[2px] group hover:border-[#C6A15A] transition-all duration-300"
                >
                  ...
                  <h3 className="text-base sm:text-lg font-bold uppercase tracking-[0.05em] text-white mb-2 group-hover:text-[#C6A15A] transition-colors duration-300">
                    {sol.title}
                  </h3>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3 sm:gap-4">
            {INDUSTRIES.map((ind, i) => {
              ...
              return (
                <div
                  key={i}
                  className="flex flex-col items-center gap-2.5 p-3.5 sm:p-4 bg-white border border-neutral-200 rounded-[2px] group hover:border-[#C6A15A] hover:shadow-md transition-all duration-300"
                >
                  <div className="w-10 h-10 rounded-[2px] bg-neutral-950 flex items-center justify-center group-hover:bg-[#101518] group-hover:border group-hover:border-[#C6A15A]/60 transition-all">
