  ...
  return (
    <main className="min-h-screen bg-white font-sans selection:bg-[#C6A15A] selection:text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            <div className="lg:col-span-7 flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-[2px] bg-[#C6A15A]/15 border border-[#C6A15A]/40 text-[#C6A15A] text-xs font-bold uppercase tracking-[0.2em] mb-5 self-start">
                <HardHat size={15} className="text-[#C6A15A]" />
      ...
      <section className="py-14 sm:py-18 bg-neutral-50 border-b border-neutral-200 overflow-hidden">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 relative">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#C6A15A] mb-2 block">END-TO-END EXECUTION</span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-4 sm:gap-6 relative z-10">
              {LIFECYCLE_STEPS.map((step, idx) => (
                <div key={idx} className="flex flex-col items-center group">
                  <div className="w-12 h-12 bg-white border-2 border-neutral-200 rounded-full flex items-center justify-center text-neutral-400 group-hover:border-[#C6A15A] group-hover:text-[#C6A15A] group-hover:shadow-md transition-all duration-300 mb-3">
      ...
      <section id="capabilities" className="py-14 sm:py-18 bg-white border-b border-neutral-200">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#C6A15A] mb-2 block">OUR EXPERTISE</span>
