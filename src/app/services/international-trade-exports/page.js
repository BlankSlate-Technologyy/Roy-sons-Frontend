...
/* ─── Data ──────────────────────────────────────────────────────── */
const CAPABILITIES = [
  { icon: Ship,        title: "Import & Export",             description: "Comprehensive multi-modal freight handling, customs clearance, and global distribution." },
  { icon: ShoppingCart,title: "International Procurement",   description: "Strategic purchasing and contract negotiation for high-volume corporate buyers." },
  { icon: Search,      title: "Global Sourcing",             description: "Identifying and vetting reliable international manufacturers and suppliers." },
  { icon: Truck,       title: "Product Distribution",        description: "B2B wholesale network expansion and channel management across borders." },
  { icon: Network,     title: "Supply Chain Management",     description: "End-to-end optimization from raw material sourcing to final delivery." },
  { icon: FileText,    title: "Trade Consultancy",           description: "Advisory on international trade regulations, tariffs, and market entry strategies." },
  { icon: Plane,       title: "Logistics Coordination",      description: "Air, sea, and land freight forwarding tailored to project timelines." },
...
export default function InternationalTradeExportsPage() {
  return (
    <main className="min-h-screen bg-white font-sans selection:bg-[#C6A15A] selection:text-white">
        ...
        <div className="max-w-screen-xl mx-auto">
          <nav aria-label="Breadcrumb">
            <ol className="flex items-center flex-wrap gap-2 text-xs sm:text-sm font-bold uppercase tracking-wider text-neutral-500">
              ...
              <li className="flex items-center gap-1.5 text-neutral-300"><ChevronRight size={14} /></li>
              <li className="text-neutral-950 font-black">International Trade &amp; Exports</li>
            </ol>
          </nav>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-7 flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-[2px] bg-[#C6A15A]/15 border border-[#C6A15A]/40 text-[#C6A15A] text-xs sm:text-sm font-black uppercase tracking-[0.22em] mb-6 self-start">
                <Globe size={16} className="text-[#C6A15A]" />
              ...
              <div className="relative rounded-[2px] p-1.5 bg-gradient-to-b from-[#C6A15A]/40 via-neutral-800 to-[#C6A15A]/20 shadow-2xl">
                <div className="relative h-[340px] sm:h-[420px] w-full overflow-hidden rounded-[2px] bg-neutral-900">
                  <Image
                    ...
                    alt="International Trade & Exports by ROYSONS"
                    fill
                    priority
                  ...
                  <div className="absolute bottom-5 left-5 right-5 p-4 bg-neutral-950/80 backdrop-blur-md border border-[#C6A15A]/40 rounded-[2px]">
                    ...
                    <p className="text-base sm:text-lg font-bold text-white leading-snug">
                      Seamless Global Commercial Networks
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
            <div className="border-l-2 border-[#C6A15A] pl-5 py-1">
              ...
              <p className="text-xs sm:text-sm font-bold uppercase tracking-wider text-neutral-500 mt-2">Years Trade Experience</p>
            </div>
            <div className="border-l-2 border-[#C6A15A] pl-5 py-1">
              <AnimatedStatValue value="50+" />
              <p className="text-xs sm:text-sm font-bold uppercase tracking-wider text-neutral-500 mt-2">Countries Connected</p>
            </div>
            <div className="border-l-2 border-[#C6A15A] pl-5 py-1">
              <AnimatedStatValue value="1,000+" />
              <p className="text-xs sm:text-sm font-bold uppercase tracking-wider text-neutral-500 mt-2">Shipments Managed</p>
            </div>
            <div className="border-l-2 border-[#C6A15A] pl-5 py-1">
              <AnimatedStatValue value="100%" />
              <p className="text-xs sm:text-sm font-bold uppercase tracking-wider text-neutral-500 mt-2">Reliability Focus</p>
            </div>
          </div>
        </div>
      </section>

      {/* Global Sourcing Highlight */}
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-center gap-10 bg-white border border-neutral-200 p-8 sm:p-12 rounded-[2px]">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-[2px] bg-neutral-950 flex items-center justify-center flex-shrink-0">
              <Globe size={36} className="text-[#C6A15A]" />
            </div>
            <div>
              <span className="text-xs sm:text-sm font-black uppercase tracking-[0.28em] text-[#C6A15A] mb-2 block">GLOBAL SOURCING</span>
              <h2 className="text-3xl sm:text-4xl font-black uppercase tracking-[0.12em] text-neutral-950 mb-4">Strategic Connections</h2>
      ...
      <section id="capabilities" className="py-20 sm:py-24 bg-white border-b border-neutral-200">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-xs sm:text-sm font-black uppercase tracking-[0.28em] text-[#C6A15A] mb-3 block">TRADE EXPERTISE</span>
      ...
      {/* CTA Banner */}
      <ConsultationBanner
        subtitle="INTERNATIONAL TRADE & EXPORTS"
        title="Connect Your Business to Global Markets"
