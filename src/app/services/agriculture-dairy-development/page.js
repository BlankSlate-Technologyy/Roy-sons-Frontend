          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            <div className="lg:col-span-7 flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-[2px] bg-[#C6A15A]/15 border border-[#C6A15A]/40 text-[#C6A15A] text-xs font-bold uppercase tracking-[0.2em] mb-5 self-start">
                <Sprout size={15} className="text-[#C6A15A]" />
      ...
      <section className="py-14 sm:py-18 bg-[#101518] text-white border-b border-neutral-800">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-[2px] bg-[#C6A15A]/10 border border-[#C6A15A]/30 flex items-center justify-center flex-shrink-0">
              <MonitorSmartphone size={28} className="text-[#C6A15A]" />
            </div>
            <div>
              <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#C6A15A] mb-2 block">FUTURE OF FARMING</span>
      ...
      <section id="capabilities" className="py-14 sm:py-18 bg-neutral-50 border-b border-neutral-200">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#C6A15A] mb-2 block">AGRI &amp; DAIRY SERVICES</span>
