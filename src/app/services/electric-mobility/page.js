          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            <div className="lg:col-span-7 flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/20 border border-white/30 text-white text-xs sm:text-[13px] font-bold uppercase tracking-[0.2em] mb-5 self-start shadow-xs backdrop-blur-xs">
                <PlugZap size={15} className="text-teal-200" />
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  <span className="text-white">Power Your Transition</span>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="bg-white p-5 sm:p-6 border border-neutral-200 rounded-[2px] hover:border-[#0a7a8c] transition-colors">
                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-[2px] bg-neutral-950 flex items-center justify-center mb-4">
                  <PlugZap size={20} className="text-[#0a7a8c]" />
                </div>
              ...
              <div className="bg-white p-5 sm:p-6 border border-neutral-200 rounded-[2px] hover:border-[#0a7a8c] transition-colors">
                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-[2px] bg-neutral-950 flex items-center justify-center mb-4">
                  <Bus size={20} className="text-[#0a7a8c]" />
                </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {CAPABILITIES.map((cap, index) => {
              const Icon = cap.icon;
              return (
                <div key={index} className="bg-neutral-50 border border-neutral-200 p-6 sm:p-7 rounded-[2px] flex flex-col justify-between group hover:border-[#0a7a8c] hover:bg-white transition-all duration-300">
                  <div>
                    <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-[2px] bg-neutral-950 flex items-center justify-center mb-5 group-hover:bg-[#101518] group-hover:border group-hover:border-[#0a7a8c]/60 transition-all duration-300">
                      <Icon size={24} strokeWidth={1.5} className="text-[#0a7a8c]" />
                    </div>
