          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-7 flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-[2px] bg-[#C6A15A]/15 border border-[#C6A15A]/40 text-[#C6A15A] text-[10.5px] font-black uppercase tracking-[0.22em] mb-5 self-start">
                <Utensils size={14} className="text-[#C6A15A]" />
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div className="border-l-2 border-[#C6A15A] pl-5 py-1">
              ...
              <p className="text-[11.5px] font-bold uppercase tracking-wider text-neutral-500 mt-1">Facilities Upgraded</p>
            </div>
            <div className="border-l-2 border-[#C6A15A] pl-5 py-1">
              <AnimatedStatValue value="50+" />
              <p className="text-[11.5px] font-bold uppercase tracking-wider text-neutral-500 mt-1">Product Lines</p>
            </div>
            <div className="border-l-2 border-[#C6A15A] pl-5 py-1">
              <AnimatedStatValue value="100%" />
              <p className="text-[11.5px] font-bold uppercase tracking-wider text-neutral-500 mt-1">Safety Compliant</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-center gap-10">
            <div className="md:w-1/3">
              <span className="text-[10.5px] font-black uppercase tracking-[0.28em] text-[#C6A15A] mb-3 block">TARGET MARKETS</span>
              <h2 className="text-2xl sm:text-3xl font-black uppercase tracking-[0.12em] text-neutral-950 mb-4">Focus Areas</h2>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                {FOCUS_AREAS.map((area, idx) => (
                  <div key={idx} className="bg-white border border-neutral-200 p-4 rounded-[2px] flex items-center gap-3 group hover:border-[#C6A15A] hover:shadow-md transition-all duration-300">
                    <span className="w-2 h-2 rounded-full bg-[#C6A15A] group-hover:scale-125 transition-transform" />
                    <span className="text-[13px] font-bold text-neutral-800 uppercase tracking-wide group-hover:text-neutral-950">{area}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section id="capabilities" className="py-20 bg-white border-b border-neutral-200">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-[10.5px] font-black uppercase tracking-[0.28em] text-[#C6A15A] mb-3 block">PROCESSING EXPERTISE</span>
