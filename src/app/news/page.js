...
export default function NewsIndexPage() {
  ...
  return (
    <main className="min-h-screen bg-white font-sans selection:bg-[#dfb753]/30 selection:text-neutral-900">
      ...
      {/* Hero Header Section with AI Generated Background */}
      <section 
        data-dark-section="true"
        className="roysons-preserve-dark pt-32 sm:pt-36 pb-16 sm:pb-20 text-white border-b border-neutral-800 relative overflow-hidden"
      >
        {/* AI Background Image */}
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/blog/news_header_bg.jpg"
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          {/* Search & Filter Bar */}
          <div className="mt-10 pt-8 border-t border-white/20 flex flex-col md:flex-row gap-4 items-center justify-between">
            {/* Category Pills */}
