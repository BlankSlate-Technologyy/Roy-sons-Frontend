  ...
  return (
    ...
    >
      <a
        ...
        className="whatsapp-float-btn group relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full shadow-[0_8px_24px_rgba(37,211,102,0.5)] hover:shadow-[0_12px_32px_rgba(10,122,140,0.65)] transition-all duration-300 hover:scale-110 active:scale-95 cursor-pointer bg-[#25D366]"
        style={{
          backgroundColor: "#25D366",
          background: "linear-gradient(135deg, #25D366 0%, #128C7E 50%, #075E54 100%)",
          backgroundImage: "linear-gradient(135deg, #25D366 0%, #128C7E 50%, #075E54 100%)",
          color: "#ffffff",
        }}
      >
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          fill="currentColor"
          className="w-8 h-8 sm:w-9 sm:h-9 text-white transition-transform duration-300 group-hover:scale-110 relative z-10 drop-shadow-sm"
        ...
        {/* Hover Tooltip Badge */}
        <span
          className="whatsapp-tooltip-badge absolute right-full mr-3.5 px-3.5 py-1.5 bg-[#042E3A] text-white text-[12px] font-bold rounded-md whitespace-nowrap shadow-xl opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 pointer-events-none border border-white/20 flex items-center justify-center text-center gap-1.5 z-50"
          style={{ backgroundColor: "#042E3A", color: "#ffffff" }}
        >
          <span className="w-2 h-2 rounded-full bg-[#25D366] inline-block shrink-0" style={{ backgroundColor: "#25D366" }} />
