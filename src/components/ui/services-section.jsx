  ...
  return (
    <div className="flex flex-row items-start gap-4 group" style={{ fontFamily: '"Times New Roman", Times, serif' }}>
      ...
      <div className="flex-1 flex flex-col justify-start">
        <h3 className="text-[18px] sm:text-[20px] font-black tracking-[0.03em] uppercase text-[#042E3A] mb-1.5 leading-snug group-hover:text-[#0a7a8c] transition-colors duration-300">
          {title}
        </h3>
        {/* Navy to Teal Separation Line */}
        <div className="w-10 h-[2px] bg-gradient-to-r from-[#042E3A] to-[#0d9488] my-2 rounded-full group-hover:w-16 transition-all duration-300" />
        <p className="text-[16px] sm:text-[17px] text-[#042E3A]/90 leading-[1.2] font-normal mb-3">
          {description}
        </p>
        <Link
          href={href || "#"}
          className="inline-flex items-center gap-1.5 text-[12px] sm:text-[13px] font-black tracking-[0.16em] uppercase text-[#0a7a8c] hover:text-[#0d9488] transition-all duration-300 group/link"
        >
