    ...
    content: (
      <>
        ...
        <p className="mb-3 text-[16.5px] sm:text-[17.5px] font-bold text-[#042E3A]">
          Medical technology can contribute to:
        </p>
        <ul className="list-disc pl-6 mb-5 space-y-2 text-[16px] sm:text-[17px] text-neutral-700 marker:text-[#0a7a8c]">
        ...
        <blockquote className="text-lg sm:text-xl font-semibold italic border-l-4 border-[#0a7a8c] pl-6 py-3 my-7 text-[#042E3A] bg-[#f0fdfa]/70 rounded-r-lg shadow-xs">
          &ldquo;Healthcare is not simply about technology. It is about using technology to create better outcomes for people.&rdquo;
        </blockquote>
      </>
    ),
  ...
  "global-trade-supply-chains": {
    ...
    content: (
      <>
        ...
        <p className="mb-3 text-[16.5px] sm:text-[17.5px] font-bold text-[#042E3A]">
          Through international sourcing and strategic partnerships, businesses can access:
        </p>
        <ul className="list-disc pl-6 mb-5 space-y-2 text-[16px] sm:text-[17px] text-neutral-700 marker:text-[#0a7a8c]">
  ...
  "building-diversified-future": {
    ...
    content: (
      <>
        ...
        <p className="mb-3 text-[16.5px] sm:text-[17.5px] font-bold text-[#042E3A]">
          For a diversified enterprise, this can create opportunities to:
        </p>
        <ul className="list-disc pl-6 mb-5 space-y-2 text-[16px] sm:text-[17px] text-neutral-700 marker:text-[#0a7a8c]">
        ...
        <blockquote className="text-lg sm:text-xl font-semibold italic border-l-4 border-[#0a7a8c] pl-6 py-3 my-7 text-[#042E3A] bg-[#f0fdfa]/70 rounded-r-lg shadow-xs">
          &ldquo;ROYSONS Pvt. Ltd. &mdash; One Vision. Multiple Industries. Global Ambition.&rdquo;
        </blockquote>
      </>
    ),
