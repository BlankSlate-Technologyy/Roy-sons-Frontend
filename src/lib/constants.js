...
export const CORPORATE_HOLDINGS = [
  { name: "Roys & Roys International", subtitle: "Healthcare Solutions & International Trade", tagline: "Providing advanced medical, laboratory, surgical, and hospital engineering solutions for healthcare institutions and government organizations.", href: "/group-companies/roys-roys", image: "/roysand roys.jpeg" },
  { name: "Vet Vac Pharma", subtitle: "Veterinary Vaccines & Animal Healthcare", tagline: "Delivering innovative veterinary vaccines, biological products, and livestock healthcare solutions for modern farming and animal health.", href: "/group-companies/Vetvacpharma", image: "/vet vec pharma.jpeg" },
  { name: "Bio Max Corporation", subtitle: "Biotechnology & Laboratory Solutions", tagline: "Supplying scientific equipment, laboratory systems, and biotechnology solutions for research and diagnostic institutions.", href: "/group-companies/biomax", image: "/bio max.jpeg" },
  ...
  { name: "German Technology Xperts (GTX)", subtitle: "Electric Mobility & Smart Transportation", tagline: "Developing electric vehicles, EV charging infrastructure, and future mobility solutions.", href: "#", image: "/gtx.jpeg" },
  { name: "Digital Zoning Corporation", subtitle: "Information Technology & Artificial Intelligence", tagline: "Providing software development, AI systems, cloud solutions, ERP platforms, and cybersecurity services.", href: "/group-companies/digital-zoning", image: "/digitaz zoning.jpeg" },
  { name: "Pakistan Consultancy Services", subtitle: "Project Consultancy & Strategic Advisory", tagline: "Offering feasibility studies, business consulting, procurement support, and investment advisory.", href: "/group-companies/pakistan-consultancy", image: "/pakistani consulancy services.jpeg" },
  { name: "TDRC – Thal Development & Research Centre", subtitle: "Research & Development Solutions", tagline: "Conducting applied research, environmental studies, and sustainable development initiatives.", href: "#", image: "/tdrc.jpeg" },
  { name: "Max Power Corporation", subtitle: "Energy & Power Solutions", tagline: "Providing renewable energy, power generation, electrical engineering, and energy storage systems.", href: "/group-companies/max-power", image: "/max power.jpeg" },
  { name: "National Food Services", subtitle: "Food Trading & Agricultural Commodities", tagline: "Specializing in commodity sourcing, food trading, exports, and supply chain management.", href: "#", image: "/national food service.jpeg" },
  { name: "Walton & Morris Foods", subtitle: "Food Processing & Manufacturing", tagline: "Producing processed food products, frozen foods, and packaged consumer goods.", href: "/group-companies/walton-mirror-food", image: "/walton&mirrorfood.jpeg" },
  { name: "Swiss Homes", subtitle: "Real Estate & Housing Development", tagline: "Developing smart housing projects, residential communities, and property investment opportunities.", href: "/group-companies/swiss-homes", image: "/swiss homes.jpeg" },
  { name: "Swiss Hut", subtitle: "Hospitality & Tourism Solutions", tagline: "Providing hospitality management, tourism development, and accommodation services.", href: "/group-companies/swiss", image: "/swiss.jpeg" },
  { name: "Neom City Corporation", subtitle: "Smart Cities & Urban Development", tagline: "Developing smart cities, commercial districts, industrial zones, and sustainable urban infrastructure.", href: "/group-companies/neom", image: "/neom.jpeg" },
  { name: "Neom City Recruitment Consultants", subtitle: "Human Resources & Recruitment Services", tagline: "Providing executive search, overseas recruitment, workforce planning, and talent acquisition services.", href: "#", image: "/neom city.jpeg" },
  { name: "Max Pak Corporation", subtitle: "Industrial Trading & Commercial Supplies", tagline: "Supplying industrial equipment, machinery, construction materials, and commercial products.", href: "/group-companies/max-pak", image: "/max pak.jpeg" },
  { name: "Inverse & Union Trading", subtitle: "International Procurement & Supply Chain", tagline: "Providing global sourcing, procurement management, and international trade solutions.", href: "/group-companies/inverse-union", image: "/inverse.jpeg" },
  { name: "Max Wood Corporation", subtitle: "Furniture Manufacturing & Interior Solutions", tagline: "Designing premium furniture, customized interiors, and wood-based architectural solutions.", href: "#", image: "/max wood.jpeg" },
  { name: "Desert Development & Rehabilitation", subtitle: "Land Development & Environmental Solutions", tagline: "Rehabilitating desert environments and developing sustainable infrastructure for arid regions.", href: "/group-companies/desert-development", image: "/desert development.jpeg" },
];
